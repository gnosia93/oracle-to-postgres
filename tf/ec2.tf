...
sudo -u ec2-user curl -o /home/ec2-user/client.zip http://ec2-3-37-255-59.ap-northeast-2.compute.amazonaws.com/instantclient-basic-linux.x64-21.1.0.0.0.zip
...
sudo -u ec2-user curl -o /home/ec2-user/sqlplus.zip http://ec2-3-37-255-59.ap-northeast-2.compute.amazonaws.com/instantclient-sqlplus-linux.x64-21.1.0.0.0.zip
