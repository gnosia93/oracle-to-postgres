...
sudo -u ec2-user curl -o /home/ec2-user/client.zip http://www.studydev.com/instantclient-basic-linux.x64-21.1.0.0.0.zip
...
sudo -u ec2-user curl -o /home/ec2-user/sqlplus.zip http://www.studydev.com/instantclient-sqlplus-linux.x64-21.1.0.0.0.zip
