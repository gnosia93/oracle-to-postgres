...
클라이언트 수를 2로 증가시켰을때 각각의 클라이언트 마다 4개의 SQL 하나의 트랜잭션으로 실행하는 것을 볼 수 있다. 

```
-bash-4.2$ pgbench -U postgres -c 2 -t 1 -j 64 -d pgbenchtest
pghost:  pgport:  nclients: 2 nxacts: 1 dbName: pgbenchtest
starting vacuum...end.
client 0 executing script "<builtin: TPC-B (sort of)>"
client 0 executing \set aid
client 0 executing \set bid
...
client 0 receiving
client 0 receiving
client 0 sending UPDATE pgbench_accounts SET abalance = abalance + -4938 WHERE aid = 3830804;
client 0 receiving
...
client 1 receiving
client 1 receiving
client 1 sending UPDATE pgbench_accounts SET abalance = abalance + -2135 WHERE aid = 6723989;
client 1 receiving
client 0 receiving
client 0 sending SELECT abalance FROM pgbench_accounts WHERE aid = 3830804;
client 0 receiving
client 0 receiving
client 0 sending UPDATE pgbench_tellers SET tbalance = tbalance + -4938 WHERE tid = 241;
client 0 receiving
client 1 receiving
client 1 sending SELECT abalance FROM pgbench_accounts WHERE aid = 6723989;
client 1 receiving
client 1 receiving
client 1 sending UPDATE pgbench_tellers SET tbalance = tbalance + -2135 WHERE tid = 474;
client 1 receiving
client 0 receiving
client 0 sending UPDATE pgbench_branches SET bbalance = bbalance + -4938 WHERE bid = 76;
client 0 receiving
client 1 receiving
client 1 sending UPDATE pgbench_branches SET bbalance = bbalance + -2135 WHERE bid = 80;
client 1 receiving
client 0 receiving
client 0 sending INSERT INTO pgbench_history (tid, bid, aid, delta, mtime) VALUES (241, 76, 3830804, -4938, CURRENT_TIMESTAMP);
client 0 receiving
client 1 receiving
client 1 sending INSERT INTO pgbench_history (tid, bid, aid, delta, mtime) VALUES (474, 80, 6723989, -2135, CURRENT_TIMESTAMP);
client 1 receiving
client 0 receiving
client 0 sending END;
client 0 receiving
...
latency average = 4.495 ms
tps = 444.913977 (including connections establishing)
tps = 725.831885 (excluding connections establishing)
```
