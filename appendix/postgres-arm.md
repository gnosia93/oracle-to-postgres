...
[ec2-user@]$ sudo yum install java-11-amazon-corretto

[ec2-user@]$ sudo amazon-linux-extras list | grep post
  4  postgresql9.6            available    [ =9.6.8  =stable ]
  5  postgresql10             available    [ =10  =stable ]
 34  postgresql11             available    [ =11  =stable ]

[ec2-user@]$ sudo amazon-linux-extras install postgresql11 epel -y

[ec2-user@]$ sudo yum install postgresql-server postgresql-contrib postgresql-devel -y

[ec2-user@]$ postgres --version
